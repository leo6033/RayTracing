...
namespace disc0ver {
    inline void DebuggingWindow::cb_Normal_i(Fl_Menu_*, void*) {
        m_debuggingView->setShadingMode(DebuggingView::ShadingMode::NORMAL);
    }
    ...
    inline void DebuggingWindow::cb_Flat_i(Fl_Menu_*, void*) {
        m_debuggingView->setShadingMode(DebuggingView::ShadingMode::FLAT_SHADING);
    }
    ...
    inline void DebuggingWindow::cb_Wireframe_i(Fl_Menu_*, void*) {
        m_debuggingView->setShadingMode(DebuggingView::ShadingMode::WIREFRAME);
    }
    ...
    inline void DebuggingWindow::cb_High_i(Fl_Menu_*, void*) {
        m_debuggingView->setQuality(DebuggingView::Quality::HIGH_QUALITY);
    }
    ...
    inline void DebuggingWindow::cb_Medium_i(Fl_Menu_*, void*) {
        m_debuggingView->setQuality(DebuggingView::Quality::MEDIUM_QUALITY);
    }
    ...
    inline void DebuggingWindow::cb_Low_i(Fl_Menu_*, void*) {
        m_debuggingView->setQuality(DebuggingView::Quality::LOW_QUALITY);
    }
    ...
    inline void DebuggingWindow::cb_Poor_i(Fl_Menu_*, void*) {
        m_debuggingView->setQuality(DebuggingView::Quality::POOR_QUALITY);
    }
    ...
    inline void DebuggingWindow::cb_Default_i(Fl_Menu_*, void*) {
        m_debuggingView->setLighting(DebuggingView::LightingMode::DEFAULT_LIGHTING);
    }
    ...
    inline void DebuggingWindow::cb_Scene_i(Fl_Menu_*, void*) {
        m_debuggingView->setLighting(DebuggingView::LightingMode::SCENE_LIGHTING);
    }
